...
';
if(!empty($_SESSION["cart_quotation_trnasfer_mini_stock"]))
{      
         $e=1;
	foreach($_SESSION["cart_quotation_trnasfer_mini_stock"] as $keys => $values)
	{
		...
		<tr>
			...
			<td>
       <input type="text" name="QTY[]" style="text-align:center" class="form-control btn-sm " id="e_qty'.$e.'"  value="'.$values["product_quantity"].'"    onkeyup="amount()" ></td>	
	   <td>
       <input type="text" name="Price[]" style="text-align:center" class="form-control  btn-sm" id="e_price'.$e.'"  value="'.@number_format($values["product_price"],2).'" onkeyup="amount()" readonly="readonly"></td>	
