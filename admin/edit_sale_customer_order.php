...
<!--</form>-->
    ...
    <!-- /.container -->
 <div class="container">   
    	<form action="update_sale_customer_order.php" method="post"  onkeydown="return event.key != 'Enter';" onsubmit="return ch_qty()" enctype="multipart/form-data" name="me">
...
<div class="modal" id="select_product">
    <div class="modal-dialog">
      <div class="modal-content">
       ...
       <form action="cart_edit_sale_customer_order.php" method="post" enctype="multipart/form-data">
...
$(document).on('keyup', '.customer_id_s', function(){
  ...
  $(document).on('click', '.add_customer', function(){
		...
		$.ajax({
			...
			method:"POST",
			data:{  customer_id:customer_id,customer_name:customer_name,ct_id:ct_id,ct_name:ct_name,route_id:route_id },
			success:function(data)
			{
				make_order_list();
			}
   ...
   $(document).on('click', '.add_order', function(){
		...
		$.ajax({
				url:"session_customer_edit.php",
			method:"POST",
			data:{  
			customer_id:customer_id,customer_name:customer_name,ct_id:ct_id,ct_name:ct_name,route_id:route_id,order_id:order_id,route_name:route_name },
			success:function(data)
			{
				//make_order_list();
				load_order_receipt();
 ...
 function make_order_list()
	{
		...
		var action ='reset';
		$.ajax({
				url:"cart_edit_sale_customer_order.php",
			method:"POST",
			data:{ action:action },
			success:function(data)
			{
 ...
 function load_order_receipt()
	{
			$.ajax({
			url:"fetch_cart_edit_sale_customer_order.php",
			method:"POST",
			//dataType:"json",
			success:function(data)
			{
