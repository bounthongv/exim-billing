...
<head>
    ...
    <meta charset="utf-8">
      <meta http-equiv="refresh" content="2; url=add_sale_stock.php">
...
extract($_GET); 
 ...
 $sql_d = mysqli_query($con,"
				 select product_sale_crate.*,sum(product_sale_crate.qty) as qty,sum(product_sale_crate.amount) as amount
				 ,products.Product_Name,customers.customer_name ,customers.phone
				 from product_sale_crate 
LEFT JOIN products ON products.Product_ID = product_sale_crate.product_id 

LEFT JOIN customers ON customers.customer_id = product_sale_crate.customer_id 
where product_sale_crate.sale_id='$sale_id'  group by product_sale_crate.product_id ");
...
<table width="720" border="0" cellspacing="0" cellpadding="0" align="center">
  <tr>
   ...
   <!-- <a href="add_sale_stock.php"><img src="<?php echo $r['path'];?>" class="img-rounded" alt="" width="80" height="50"></a>-->
    <br>
   ຮ້ານຄ້າ
   <br>
   <br>
  ...
  <tr valign="top">
    ...
    ເງື່ອນໄຂການຊຳລະ: Cash
     ...
     <br>ພະນັກງານ: <?php echo $ff['phone'];?>
				 ...
				 select product_sale_crate.*,sum(product_sale_crate.qty) as qty,sum(product_sale_crate.amount) as amount
				 ,products.Product_Name,customers.customer_name,products.Unit 
				 from product_sale_crate 
LEFT JOIN products ON products.Product_ID = product_sale_crate.product_id 
LEFT JOIN customers ON customers.customer_id = product_sale_crate.customer_id 
where product_sale_crate.sale_id='$sale_id'  group by product_sale_crate.product_id ");
                ...
                while($f = mysqli_fetch_array($sql)){        ?>
                     ...
                     <?php       
                          ...
                          <td valign="top" align="left"><?php echo $f['Product_Name'];?></td>
                            ...
                            <td align="center" valign="top"><?php echo $f['qty'];?></td>
                             <td align="center" valign="top"><?php echo $f['Unit'];?></td>
                                <td valign="top" align="right"><?php echo $f['price'];?></td>                     
                       
                            <td align="right" valign="top"><?php echo @number_format($f['discount'],2);?></td>
                             <td align="right" valign="top"><?php echo @number_format($f['amount'],2);?></td>
                       ...
                       <?php
						...
						@$t_amount +=$f['price']*$f['qty'];
						@$total_discount+=$f['discount'];
   ...
   <tr>
        ...
        <td rowspan="4" colspan="5" valign="top" align="right"></td>
  </tr>   	
        
         <tr><td align="right">Sub Total:</td> <td align="right"><?php echo @number_format($t_amount,2);?></td></tr>
         <tr><td align="right">Less Cash Disc:</td><td align="right"> &nbsp; <?php echo @number_format($total_discount,2);?></td></tr>
         <tr><td align="right">Sub Total:</td>  <td align="right"><?php echo @number_format($total_amount,2);?></td></tr>
