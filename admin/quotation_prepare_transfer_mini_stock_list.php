 ...
 function load_list()
	{
		 var stock_id = $('#stock_id').val(); 
  		 ...
  		 var to_date = $('#to_date').val();
			...
			url:"fetch_prepare_quotation_transfer_mini_list.php",
			method:"POST",
			//dataType:"json",
			data:{  stock_id:stock_id,from_date:from_date,to_date:to_date,transfer_id:transfer_id },
...
function load_product()
	{
			$.ajax({
			url:"fetch_quotation_transfer_mini_detail.php",
			method:"POST",
			//dataType:"json",
			success:function(data)
			{
...
$(document).on('click', '.delete_Id', function(){
  ...
  if (r == true) {
     window.location = 'delete_quotation_transfer_product.php?transfer_id='+transfer_id ;
  } 
...
$(document).on('click', '.print', function(){
     ...
     window.open('print_quotation_prepare_transfer_mini_stock_list.php?transfer_id='+transfer_id+'&stock_id='+stock_id+'&from_date='+from_date+'&to_date='+to_date+'','_blank');
...
<div class="container">
    <br>
    <h3 align="center">ລາຍງານໃບສະເໜີຂໍເບີກເຄື່ອງ </h3><br>
...
<table>
 ...
 $user_stock_id=$_SESSION['stock_id'];
  if($user_status=='0'){     ?>
    ...
    <td>ເລກທີ<br><input  type="text" name="transfer_id" id="transfer_id" class="form-control"  ></td>
    <td><br><button type="button" class="btn btn-warning print" id="print"><i class="fa fa-print"></i> ພິມ</button></td> 
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-header">
          <h4 class="modal-title">ລາຍການໃບສະເໜີຂໍເບີກເຄື່ອງ</h4>
