...
$(document).ready(function(){
 ...
 function load_list()
	{
			$.ajax({
			url:"fetch_close_opening_list.php",
			method:"POST",
			//dataType:"json",
...
$(function(){
  $('#create_opening').click(function(){
   ...
   var action ="create";
 //  alert(stock_id);
   if(stock_id==''){ alert('ກະລຸນາເລືອກສາງ'); $('#stock_id').focus(); }
   else{
         $.ajax({
				url:"insert_close_opening.php",
				method:"POST",
...
<table>
       ...
       <td> <br><button type="button" class="btn btn-warning"  id="create_opening" >
            <i class="fa fa-plus-square"></i>&nbsp; ປິດບັນຊີ</button></td>  
