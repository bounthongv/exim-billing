...
$(document).on('click', '#print', function(){
   ...
   var group_id = $('#group_id').val(); 
	//	var action = $(this).attr("value");
     ...
     window.open('print_sale_by_product.php?stock_id='+stock_id + '&from_date='+from_date  + '&to_date='+to_date+ '&product_id='+product_id+ '&group_id='+group_id+' ','_blank'); 
...
<div class="container">
    <br>
    <h3 align="center">ລາຍງານການຂາຍຕາມສິນຄ້າ</h3><br>
