...
<?php 
    ...
    select *,total_amt-payment as debit from (   
       ...
       SELECT product_sale.*,count(product_sale.product_id) as total_item,stocks.stock_name
	   ...
	   group by product_sale.sale_id order by product_sale.sale_id       ) as tb_a where  payment < total_amt 
