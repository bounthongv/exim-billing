...
$sql_max=mysqli_query($con,"SELECT max(`no`) from tbl_emp_no");
...
<td align="center">ເລກລົດ: <br><input type="text" class="form-control" name="Truck_Number" id="Truck_Number" value=""  ></td>
