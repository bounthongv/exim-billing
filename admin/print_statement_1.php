...
$sql = "SELECT * from tb_statement order by inv_date, inv_no asc";
$i=1;
...
@$sql_select=mysqli_query($con,"SELECT * from tb_statement");
...
$stt=0;
     ...
     /*     
SELECT tb_statement.*,customers.customer_name from tb_statement 
