...
extract($_GET); 
 ...
 $sql_d = mysqli_query($con,"
				 select orders.*,sum(orders.qty) as qty,sum(orders.amount) as amount,products.Product_Name,customers.customer_name ,customers.phone
				 from orders 
LEFT JOIN products ON products.Product_ID = orders.product_id 

LEFT JOIN customers ON customers.customer_id = orders.customer_id 
where orders.sale_id='$sale_id'  group by orders.product_id ");
...
<table width="720" border="0" cellspacing="0" cellpadding="0" align="center">
  <tr>
   ...
   <br>
    ...
    <td scope="col" width="240" align="center"><h2 align="center">ໃບສັ່ງຈອງ <br >
    <b>Order</b><br>
      &nbsp;
    </h2></td>
  ...
  <tr valign="top">
    ...
    ເງື່ອນໄຂການຊຳລະ: Cash
     ...
     <br>ພະນັກງານ: <?php echo $ff['phone'];?>
				 ...
				 select orders.*,sum(orders.qty) as qty,sum(orders.amount) as amount,products.Product_Name,customers.customer_name,products.Unit 
				 from orders 
LEFT JOIN products ON products.Product_ID = orders.product_id 
LEFT JOIN customers ON customers.customer_id = orders.customer_id 
where orders.sale_id='$sale_id'  group by orders.product_id ");
