...
<table border="0">
  <tr>
    ...
    <td ><input type="text" class="form-control input" name="product_id" id="product_id" value="<?php if(isset($_GET['product_id'])){ echo mysqli_real_escape_string($con,$_GET['product_id']);}else{} ?>" ></td>
  ...
  <tr>
    ...
    <td><input type="text" class="form-control" name="price" id="price" onkeyup="total_amount()" required  ></td>
    <td align="right">ຈຳນວນ:</td>
    <td ><input type="text" class="form-control" name="qty" id="qty" onkeyup="total_amount()"  required></td>
  </tr>
