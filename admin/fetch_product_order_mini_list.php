<?php 
  include("init.php");
		...
		elseif($price_type=='004'){ $pp=",products.s4_price  as price";}
		elseif($price_type=='005'){ $pp=",products.seven_eleven  as price";}
		elseif($price_type=='006'){ $pp=",products.function  as price";}
