...
<div class="container">
    <br>
    <h3 align="center">ລາຍການໃບສັ່ງຊື້ພະນັກງານຂາຍ</h3><br>
...
<table>
     ...
     <td> <br>  <a href="index.php"> <button type="button" name="reset" value="reset" class="btn btn-danger"><i class="fa fa-times"></i>&nbsp;ປິດ</button></a></td>
       <td> <br><a href="add_seller_order.php"  ><button type="button" class="btn btn-success" >
...
$(document).ready(function(){
 ...
 //  alert(stock_id);
         ...
         $.ajax({
				url:"fetch_seller_order_list.php",
				method:"POST",
...
function load_product()
	{
			$.ajax({
			url:"fetch_seller_order_detail.php",
			method:"POST",
			//dataType:"json",
			success:function(data)
			{
...
$(document).on('click', '.delete_Id', function(){
  ...
  if (r == true) {
     window.location = 'delete_seller_order.php?order_id='+order_id ;
  } 
...
$(document).on('click', '.edit_Id', function(){
	...
	//	var action = $(this).attr("value");
     ...
     window.location = 'cart_order_edit.php?order_id='+order_id ;
