...
<script src='jquery-3.1.1.min.js' type='text/javascript'></script>
 ...
 <link rel="stylesheet" href="select_box/select2.min.css">
<script src="select_box/select2.full.min.js"></script>
<script>
...
<!--</form>-->
    ...
    <!-- /.container -->
 <div class="container">   
    	<form action="insert_add_sale_stock.php" method="post"  onkeydown="return event.key != 'Enter';" onsubmit="return ch_qty()" enctype="multipart/form-data" name="me">
...
<table border="0">
  ...
  <tr>
    ...
    <input type="text" class="form-control ss" name="refer_no" id="refer_no" value="<?php if(@$_SESSION['order_id']!==''){ echo @$_SESSION['order_id'];}else{} ?>" >    
   <span class="input-group-addon">
   <button type="button" name="cc" class="btn btn-sm " data-toggle="modal" data-target="#seller_order" ><i class="fa fa-search"></i></button> </span>   
    </div>
 ...
 <tr>
  ...
  <tr>
    ...
    value="<?php if(isset($_GET['c_id'])){ echo $_GET['c_id'].'&nbsp;'.$_GET['c_name']; }else{ echo @$_SESSION['customer_name'];} ?>" >      
   <span class="input-group-addon">
   <button type="button" name="cc" class="btn btn-sm " data-toggle="modal" data-target="#customer_add" ><i class="fa fa-search"></i></button> </span>   
    ...
    <input type="hidden" class="form-control" name="customer_id"   id="customer_id" value="<?php if(isset($_GET['c_id'])){ echo $_GET['c_id']; }else{  if(isset($_SESSION['customer_id'])){echo $_SESSION['customer_id'];}else{echo 'C0001';}} ?>"  >
   ...
   elseif($_GET['c_t']=='003'){ echo ' <option value="003">ລາຄາຂາຍ</option>';}
	...
	<?PHP } ?>
      ...
      <td align="right" colspan="1">ນັດຊຳລະ:</td>
    <td colspan="1">  
    <input type="date" name="plan_date" id="plan_date" class="form-control">
     </td>
...
<td valign="middle">
ລາຍລະອຽດ: <br>
 <textarea name="remark" id="remark" rows="10" cols="80"></textarea>
 ...
 <form action="cart_transfer_from_mini_stock.php"  onkeydown="return event.key != 'Enter';" method="post"  enctype="multipart/form-data">
...
<div class="modal" id="seller_order">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <table>
             ...
             <td>ສາງ<br><input  type="text" name="stock_id_s" id="stock_id_s" onkeyup="search22()" class="form-control"  ></td> 
 ...
 <?php
         @$sp=mysqli_query($con,"
SELECT seller_orders.*,count(seller_orders.product_id) as total_item,stocks.stock_name,products.Product_ID,products.Product_Name,products.size,products.Unit 
       ...
       where      seller_orders.status!='2' 
	   group by seller_orders.order_id order by seller_orders.product_id
...
function search22() {
  var input, filter, table, tr, td, i, txtValue;
  input = document.getElementById("stock_id_s");
  filter = input.value.toUpperCase();
  table = document.getElementById("refer2");
  tr = table.getElementsByTagName("tr");
  for (i = 0; i < tr.length; i++) {
		   ...
		   $i=1;
			...
			?>
			  ...
			  <td align="center"><?php echo $i; ?></td>
			   <td align="center"><?php echo  $s["order_id"]; ?></td> 
				...
				<td align="center">
                <a href="cart_seller_order_refer_no_sale.php?order_id=<?=$s['order_id'];?>">
