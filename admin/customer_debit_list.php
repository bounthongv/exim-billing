...
function load_product()
 ...
 //  alert(stock_id);
         ...
         $.ajax({
				url:"fetch_customer_debit_list.php",
				method:"POST",
				data:{  stock_id:stock_id,from_date:from_date,to_date:to_date,sale_id:sale_id,summary:summary },
...
$(function(){
 ...
 //  alert(stock_id);
         ...
         $.ajax({
				url:"fetch_customer_debit_list.php",
				method:"POST",
	data:{  stock_id:stock_id,from_date:from_date,to_date:to_date,sale_id:sale_id,summary:summary,customer_id:customer_id },
				success:function(data)
				{
					$('#head_list').html(data);
...
$(document).on('click', '#print', function(){
  ...
  // var group_id = $('#group_id').val(); 
	//	var action = $(this).attr("value");
     ...
     window.open('print_customer_debit_list.php?stock_id='+stock_id+'&from_date='+from_date+'&to_date='+to_date+'&sale_id='+sale_id+'&customer_id='+customer_id+'&summary='+summary+'','_blank'); 
...
<div class="container">
    <br>
    <h3 align="center">ລາຍການໃບບິນຂາຍຕິດໜີ້</h3><br>
...
<table>
	...
	<?PHP } ?>
             ...
             <td>ລະຫັດລູກຄ້າ<br><input  type="text" name="customer_id" id="customer_id" class="form-control"  ></td> 
             <td>ເລກບິນ<br><input  type="text" name="sale_id" id="sale_id" class="form-control"  ></td> 
  <td>ຮູບແບບ<br>
  <select name="summary" id="summary" class="form-control" >
  		<option value="1">ສັງລວມ</option>
        <option value="2">ລະອຽດ</option>
  </select>
  </td> 
