...
function load_product()
	{
			$.ajax({
			url:"fetch_product_pre_order_detail.php",
			method:"POST",
			//dataType:"json",
			success:function(data)
			{
...
$(document).on('click', '.delete_Id', function(){
  ...
  if (r == true) {
     window.location = 'delete_order.php?sale_id='+sale_id ;
  } 
...
$(document).on('click', '.edit_Id', function(){
	...
	//	var action = $(this).attr("value");
     ...
     window.location = 'cart_order_edit.php?sale_id='+sale_id ;
...
$(document).on('click', '#print', function(){
  ...
  // var group_id = $('#group_id').val(); 
	//	var action = $(this).attr("value");
     ...
     window.open('print_order_list.php?stock_id='+stock_id + '&from_date='+from_date  + '&to_date='+to_date+' ','_blank'); 
...
<div class="container">
    <br>
    <h3 align="center">ລາຍການໃບສັ່ງຈອງ</h3><br>
...
<table>
     ...
     <td> <br>  <a href="index.php"> <button type="button" name="reset" value="reset" class="btn btn-danger"><i class="fa fa-times"></i>&nbsp;ປິດ</button></a></td>
       <td> <br><a href="add_order.php"  ><button type="button" class="btn btn-success" >
            <i class="fa fa-plus-square"></i>&nbsp; ສ້າງໃບສັ່ງຈອງ</button></a></td>
