...
<tr>
    ...
    <td width="30%" colspan="1" align="center" ><h5>ໃບສົ່ງເຄື່ອງ/PO</h5></td>
...
<table width="700" border="1">
  <tr align="center">
   ...
   <?php 
	 ...
	 $sql = mysqli_query($con," select product_customer_order.* ,sum(product_customer_order.qty) as t_qty
	 ,sum(product_customer_order.amount) as t_amount
