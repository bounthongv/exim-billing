...
-->
			...
			<?php
@$s1 = mysqli_query($con,"SELECT * from tbl_empty_return_note where `no`='$no'");
...
<tr>
    ...
    <td width="30%" colspan="1" align="center" ><h5>ໃບສັ່ງລັງ ແລະ ແກ້ວເປົ່າ <br> Empty Return Note</h5></td>
...
<table width="100%" border="1">
  <tr align="center">
   ...
   <?php 
	 ...
	 $sql = mysqli_query($con,"SELECT `Description`,count(`Description`) as count_Description from tbl_empty_return_note where `no`='$no' group by `Description`");
...
<?php 
  $e=1;
                          @$sql1 = mysqli_query($con,"SELECT * from tbl_empty_return_note where `Description`='$Description'");
    ...
    <td align="center" <?php if($count_Description==$e){ ?>style='border-bottom:2pt solid black;'<?php }else{?> style='' <?php };?>><?php echo $f1["Customer_Count"];?></td>
    <td align="center" <?php if($count_Description==$e){ ?>style='border-bottom:2pt solid black;'<?php }else{?> style='' <?php };?>><?php echo $f1["Driver_Count"];?></td>
    <td align="center" <?php if($count_Description==$e){ ?>style='border-bottom:2pt solid black;'<?php }else{?> style='' <?php };?>><?php echo $f1["Driver_Count_in_WareHouse"];?></td>
    <td align="center" <?php if($count_Description==$e){ ?>style='border-bottom:2pt solid black;'<?php }else{?> style='' <?php };?>><?php echo $f1["Storekeeper_Count"];?></td>
    <td align="center" <?php if($count_Description==$e){ ?>style='border-bottom:2pt solid black;'<?php }else{?> style='' <?php };?>><?php echo $f1["Detall_of_Information"];?></td>
