...
<div class="container">
    <br>
    <h3 align="center">ໃບສະເໜີລາຄາ</h3><br>
  </div> 
...
<!--</form>-->
    ...
    <!-- /.container -->
 <div class="container">   
    	<form action="insert_add_quotation_stock.php" method="post" onsubmit="return ch_qty()" enctype="multipart/form-data" name="me">
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <tr>         
         ...
         <td><a href="add_quotation.php?c_id=<?=$f['customer_id'];?>&c_name=<?=$f['customer_name'];?>&c_t=<?=$f['customer_type'];?>"><button type="button" name="cc" class="btn btn-sm btn-success" >ເລືອກ</button></a></td>
        </tr>
        <?php } ?>
