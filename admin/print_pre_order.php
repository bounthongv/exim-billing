...
extract($_GET); 
 ...
 $sql_d = mysqli_query($con,"
				 select pre_orders.*,sum(pre_orders.qty) as qty,sum(pre_orders.amount) as amount,products.Product_Name,customers.customer_name ,customers.phone
				 from pre_orders 
...
where pre_orders.sale_id='$sale_id'  group by pre_orders.product_id ");
...
<table width="720" border="0" cellspacing="0" cellpadding="0" align="center">
  <tr>
   ...
   <br>
    ...
    <td scope="col" width="240" align="center"><h2 align="center">ໃບສັ່ງຊື້ <br >
    <b>Order</b><br>
      &nbsp;
    </h2></td>
  ...
  <tr valign="top">
    ...
    ເງື່ອນໄຂການຊຳລະ: Cash
     ...
     <br>ພະນັກງານ: <?php echo $ff['phone'];?>
				 ...
				 select pre_orders.*,sum(pre_orders.qty) as qty,sum(pre_orders.amount) as amount,products.Product_Name,customers.customer_name,products.Unit 
				 from pre_orders 
LEFT JOIN products ON products.Product_ID = pre_orders.product_id 
LEFT JOIN customers ON customers.customer_id = pre_orders.customer_id 
where pre_orders.sale_id='$sale_id'  group by pre_orders.product_id ");
