...
extract($_GET); 
 ...
 $sql_d = mysqli_query($con,"
				 ...
				 ,payment.pay_lak,payment.pay_thb,payment.pay_usd,payment.pay_date
				 from payment 
	LEFT JOIN product_sale ON product_sale.sale_id = payment.sale_id 			 
...
where payment.pay_id='$sale_id'  group by product_sale.product_id ");
...
<table width="720" border="0" cellspacing="0" cellpadding="0" align="center">
  <tr>
   ...
   <br>
    ...
    <td scope="col" width="240" align="center"><h2 align="center">ໃບຮັບເງີນ <br ><b class="time_n">RECEIPT</b>
      <br>
      &nbsp;
    </h2></td>
    <td width="240" align="center" scope="col" >ເລກທີບິນ: <b class="time_n"><?php echo $sale_id;?></b>
    
        <br>ວັນທີ:<?php $date=date_create($ff['pay_date']);
...
<table width="720" align="center" border="1" cellspacing="0" cellpadding="0" >
  <tr valign="top">
    ...
    ເງື່ອນໄຂການຊຳລະ: Cash
     <br>ເລກທີອ້າງອີງ: <?php echo $ff['sale_id'];?>
...
where payment.pay_id='$sale_id'  group by product_sale.product_id ");
   ...
   <tr>
     <td colspan="2" align="right"><?php echo number_format($ff['pay_lak'],2);?></td>
     <td align="right"><?php echo number_format($ff['pay_thb'],2);?></td>
     <td align="right"><?php echo number_format($ff['pay_usd'],2);?></td>
