...
$(document).ready(function(){
 ...
 function load_list()
	{
			$.ajax({
			url:"fetch_quotation_transfer_mini_list.php",
			method:"POST",
			//dataType:"json",
...
$(document).on('click', '.edit_Id', function(){
	...
	//	var action = $(this).attr("value");
     ...
     window.location = 'cart_quotation_transfer_mini_stock_edit.php?transfer_id='+transfer_id ;
...
<div class="container">
    <br>
    <h3 align="center">ລາຍການໃບສະເໜີຂໍເບີກເຄື່ອງ </h3><br>
   
<table>
       <tr>
       <td><br><a href="index.php"><button type="button" name="close"  class="btn btn-danger"><i class="fa fa-trash-o"></i>&nbsp;ປິດ</button></a></td>
       <td> <br><a href="add_quotation_transfer_mini_stock.php"  ><button type="button" class="btn btn-success" >
            <i class="fa fa-plus-square"></i>&nbsp; ສ້າງ</button></a></td>
