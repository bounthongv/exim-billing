...
$(document).ready(function(){
 ...
 function load_list()
	{
			$.ajax({
			url:"fetch_transfer_mini_list.php",
			method:"POST",
			//dataType:"json",
...
$(document).on('click', '.delete_Id', function(){
  ...
  if (r == true) {
     window.location = 'delete_transfer_product.php?transfer_id='+transfer_id ;
  } 
...
<div class="container">
    <br>
    <h3 align="center">ລາຍການຮັບຄືນຈາກສາງລົດ</h3><br>
   
<table>
       <tr>
       <td><br><a href="index.php"><button type="button" name="close"  class="btn btn-danger"><i class="fa fa-trash-o"></i>&nbsp;ປິດ</button></a></td>
       <td> <br><a href="transfer_from_mini_stock.php"  ><button type="button" class="btn btn-success" >
            <i class="fa fa-plus-square"></i>&nbsp; ຮັບ</button></a></td>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-header">
          <h4 class="modal-title">ລາຍການຈ່າຍສີນຄ້າໃຫ້ສາງລົດ</h4>
