...
$(document).ready(function(){
 ...
 function load_list()
	{
			$.ajax({
			url:"fetch_product_receipt_report.php",
			method:"POST",
			//dataType:"json",
...
$(function(){
 ...
 //  alert(stock_id);
         ...
         $.ajax({
				...
				method:"POST",
				data:{ 
	 stock_id:stock_id,from_date:from_date,to_date:to_date,sale_id:sale_id,product_id:product_id,group_id:group_id,select_mode:select_mode },
				success:function(data)
				{
					$('#head_list').html(data);
...
$(document).on('click', '#print', function(){
   ...
   var select_mode = $('#select_mode').val();
     ...
     window.open('print_fetch_product_receipt_report.php?stock_id='+stock_id+'&from_date='+from_date+'&to_date='+to_date+'&product_id='+product_id+'&group_id='+group_id+'&sale_id='+sale_id+'&select_mode='+select_mode+' ','_blank'); 
...
$(document).on('click', '#print_excel', function(){
  ...
  window.open('print_fetch_product_receipt_report_excel.php?stock_id='+stock_id+'&from_date='+from_date+'&to_date='+to_date+'&product_id='+product_id+'&group_id='+group_id+'&sale_id='+sale_id+'&select_mode='+select_mode+' ','_blank');
    ...
    <br>
    <h3 align="center">ລາຍງານການຮັບສິນຄ້າເຂົ້າສາງ</h3><br>
