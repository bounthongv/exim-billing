...
<?php
 $sql_max=mysqli_query($con,"select max(stock_id) from stocks");
...
/////////////////////////////////////
  ...
  if (r == true) {
     window.location = 'delete_stock.php?Id='+Id;
  } 
...
<div class="container">
    <br>
    <h3 align="center">ລາຍການສາງສິນຄ້າ</h3><br>
   


          
            <button type="button" class="btn btn-success" data-toggle="modal" data-target="#add_stock">
            <i class="fa fa-plus-square"></i>&nbsp; ເພີ່ມ ລາຍການສາງ</button>
...
<div class="modal" id="add_stock">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-header">
          <h4 class="modal-title">ເພີ່ມລາຍການສາງ</h4>
  ...
  <tr>
    ...
    <td><input type="text" class="form-control" name="stock_id" id="stock_id" value="<?php echo $group_id; ?>"  placeholder="Stocklis ID" >
  ...
  <tr>
    ...
    <td><input type="text" class="form-control" name="stock_name" id="stock_name"  placeholder="Stock Name" ></td> 
