...
<!--</form>-->
    ...
    <!-- /.container -->
 <div class="container">   
    	<form action="insert_customer_order.php" method="post"  onkeydown="return event.key != 'Enter';" onsubmit="return ch_qty()" enctype="multipart/form-data" name="me">

	<div class="form-group row">
    <div class="col-sm-10">
    <a href="index.php"><button type="button" name="close"  class="btn btn-danger"><i class="fa fa-times"></i>&nbsp;ປິດ</button></a>
     <a href="cart_customer_order.php?action=empty" ><button type="button" class="btn btn-success"><i class="fa fa-plus-square"></i>&nbsp;ເພີ່ມໃໜ່</button></a>
      
      <button type="submit" name="save"  class="btn btn-primary" ><i class="fa fa-file"></i>&nbsp;ບັນທືກ</button>
      
      <a href="cart_customer_order.php?action=empty" ><button type="button" name="reset" value="reset" class="btn btn-warning"><i class="fa fa-trash-o"></i>&nbsp;ລືບ</button></a>
     </div>
     </div>
...
<table border="0">
  ...
  <td align="center">ວັນທີສັ່ງ: <br><input type="date" class="form-control" name="sale_date" id="sale_date" value="<?php echo @date('Y-m-d');  ?>"  required></td>
 ...
 <tr>
  ...
  <td>ພະນັກງານຂາຍ: <br><?PHP 
    ...
    <td>ໝາຍເຫດ: <br><input type="text"  name="remark" id="remark" class="form-control" ></td>
  </tr>
...
<div class="modal" id="select_product">
    <div class="modal-dialog">
      <div class="modal-content">
       ...
       <form action="cart_customer_order.php" method="post" enctype="multipart/form-data">
...
$(document).on('keyup', '.customer_id_s', function(){
 ...
 function load_order_receipt()
	{
			$.ajax({
			url:"fetch_cart_customer_order.php",
			method:"POST",
			//dataType:"json",
			success:function(data)
			{
