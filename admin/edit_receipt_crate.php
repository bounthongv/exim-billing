...
<!--</form>-->
    ...
    <!-- /.container -->
    	...
    	<form action="update_receipt_crate.php" method="post"  onkeydown="return event.key != 'Enter';" onsubmit="return ch_qty()" enctype="multipart/form-data" name="me">
<div class="container"> 
	<div class="form-group row">
    <div class="col-sm-10">
    <a href="index.php"><button type="button" name="close"  class="btn btn-danger"><i class="fa fa-times"></i>&nbsp;ປິດ</button></a>
     <a href="cart_edit_receipt_crate.php?action=empty" ><button type="button" class="btn btn-success"><i class="fa fa-plus-square"></i>&nbsp;ເພີ່ມໃໜ່</button></a>
      
      <button type="submit" name="save"  class="btn btn-primary" ><i class="fa fa-file"></i>&nbsp;ບັນທືກ</button>
      
      <a href="cart_edit_receipt_crate.php?action=empty" ><button type="button" name="reset" value="reset" class="btn btn-warning"><i class="fa fa-trash-o"></i>&nbsp;ລືບ</button></a>
     </div>
     </div>
...
<table border="0">
  ...
  <tr> 
    <td align="center">ເລກທີ: <br><input type="text" class="form-control ss" name="receipt_id" id="receipt_id" value="<?php echo $_SESSION["receipt_id"]; ?>" readonly ></td>
   <td align="center">ວັນທີ: <br><input type="date" class="form-control" name="receipt_date" id="receipt_date" value="<?php echo $_SESSION["receipt_date"];  ?>"  required> </td>
 ...
 <tr>
  ...
  <tr>
    ...
    <input type="text" class="form-control ss" name="customer_name" id="customer_name" value="<?php echo $_SESSION["customer_name"]; ?>" readonly >      
...
$(document).on('keyup', '.customer_id_s', function(){
 ...
 function make_order_list()
	{
		...
		var action ='make_cart';
			...
			$.ajax({
				url:"cart_edit_receipt_crate.php",
			method:"POST",
 ...
 function load_order_receipt()
	{
			$.ajax({
			url:"fetch_cart_edit_receipt_crate.php",
			method:"POST",
			//dataType:"json",
			success:function(data)
			{
