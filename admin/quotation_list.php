...
function load_product()
	{
			$.ajax({
			url:"fetch_product_quotation_detail.php",
			method:"POST",
			//dataType:"json",
			success:function(data)
			{
...
$(function(){
 ...
 //  alert(stock_id);
         ...
         $.ajax({
				url:"fetch_quotation_list.php",
				method:"POST",
				data:{  stock_id:stock_id,from_date:from_date,to_date:to_date,sale_id:sale_id },
				success:function(data)
				{
					$('#head_list').html(data);
...
$(document).on('click', '.delete_Id', function(){
  ...
  if (r == true) {
     window.location = 'delete_quotations.php?sale_id='+sale_id ;
  } 
...
$(document).on('click', '.edit_Id', function(){
  ...
  //   window.location = 'cart_quotation_edit.php?sale_id='+sale_id ;
...
$(document).on('click', '#print', function(){
  ...
  // var group_id = $('#group_id').val(); 
	//	var action = $(this).attr("value");
     ...
     window.open('print_quotation_list.php?stock_id='+stock_id + '&from_date='+from_date  + '&to_date='+to_date+' ','_blank'); 
...
<div class="container">
    <br>
    <h3 align="center">ລາຍການໃບສະເໜີລາຄາ</h3><br>
...
<table>
     ...
     <td> <br>  <a href="product_qty_list.php"> <button type="button" name="reset" value="reset" class="btn btn-danger"><i class="fa fa-times"></i>&nbsp;ປິດ</button></a></td>
       <td> <br><a href="add_quotation.php"  ><button type="button" class="btn btn-success" >
            <i class="fa fa-plus-square"></i>&nbsp; ສ້າງໃບສະເໜີລາຄາ</button></a></td>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-header">
          <h4 class="modal-title">ລາຍການໃບສະເໜີລາຄາ</h4>
