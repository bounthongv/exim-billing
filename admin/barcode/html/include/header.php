...
{ 
  var disp_setting="toolbar=yes,location=no,directories=yes,menubar=yes,"; 
      disp_setting+="scrollbars=yes,width=500,hight=300,  top=25,"; 
  var content_vlue = document.getElementById("imageOutput").innerHTML; 
  
  var docprint=window.open("","",disp_setting); 
   docprint.document.open(); 
   docprint.document.write('</head><body onLoad="self.print()" style="width: 802px; margin-top:28px; margin-left:16px;    font-size:11px; font-family:arial; font-weight:normal; ">');          
...
<?php
$huyu=filter_var($_GET['id'], FILTER_SANITIZE_STRING);
$default_value = array();
