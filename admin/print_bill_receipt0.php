...
<tr>
  ...
  <td colspan="3"  >ຊື່ລູກຄ້າ: <?php echo $ff['customer_name']; ?> <br>
    ລະຫັດ: <?php echo $ff['customer_id']; ?>  ທີ່ຢູ່ລູກຄ້າ: <?php echo $ff['address']; ?><br> ເບີໂທ: <?php echo $ff['phone']; ?></td>
  <td colspan="3" width="52%" align="right" valign="top">Acc Name: EXIM SOLE CO.,LTD.<br>
                                             Acct.: 162.12.00.00335568.001
  <br><br>
  <strong> ສາງ: <?php echo $ff['User_Name']; ?> &nbsp;</strong>
  </td>
  </tr>
</table>
...
<table width="349" border="1">
  ...
  <td colspan="2"  align="right"><strong><?php echo @number_format($amount,0); ?></strong></td>
  </tr>
</table>
<br>
<table width="300" border="0">
  <tr align="center">
    <td><strong>ຜູ້ຮັບເຄື່ອງ<br>Receiver</strong></td>
    <td><strong><br></strong></td>
    <td><strong><br></strong></td>
    <td colspan="3"  align="center"><strong> &nbsp; &nbsp;ຜູ້ສົ່ງເຄື່ອງ<br>Cashair</strong></td>
