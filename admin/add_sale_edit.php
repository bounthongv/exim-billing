...
<!--</form>-->
 ...
 <div class="container">   
    ...
    <a href="index.php"><button type="button" name="close"  class="btn btn-danger"><i class="fa fa-times"></i>&nbsp;ປິດ</button></a>
      <a href="add_sale_edit.php"><button type="button" class="btn btn-success"><i class="fa fa-plus-square"></i>&nbsp;ເພີ່ມໃໜ່</button></a>
 ...
 <tr>
  ...
  <tr>
   ...
   elseif($_GET['c_t']=='003'){ echo ' <option value="003">ລາຄາຂາຍ</option>';}
    ...
    <td colspan="1">  
    <input type="date" name="plan_date" id="plan_date" class="form-control" value="<?php echo @$_SESSION["plan_date"]; ?>">
     </td>
  </tr>
...
<table  border="0" >
  ...
  <tr>
    ...
    <td   align="right">
    <input type="text" name="payment_thb" id="payment_thb" onkeyup="key_press()" value="<?php echo $_SESSION['pay_thb']; ?>"  required  class="form-control sinput">
      </td>
      <td   align="right">
    <input type="text" name="payment_lak" id="payment_lak" onkeyup="key_press()" value="<?php echo $_SESSION['pay_lak']; ?>"  required  class="form-control sinput">
      </td>
       <td   align="right">
    <input type="text" name="payment_usd" id="payment_usd" onkeyup="key_press()" value="<?php echo $_SESSION['pay_usd']; ?>"  required  class="form-control sinput">
      </td>
  </tr>
  <tr>
...
<td valign="middle">
ລາຍລະອຽດ: <br>
 <textarea name="remark" id="remark" rows="10" cols="80"><?php echo @$_SESSION["remark_no"]; ?></textarea>
