      ...
      <a href="add_users.php"><button type="button" class="btn btn-success"><i class="fa fa-plus-square"></i>&nbsp;ເພີ່ມໃໜ່</button></a>
        ...
        <table width="352" border="0">
          <tr>
            ...
            <td width="261" ><input type="text" class="form-control" name="User_ID" value="<?=$User_ID;?>" readonly></td>
          </tr>
          <tr>
            <td align="right">ຊື່ຜູ້ໃຊ້:</td>
        ...
        <tr>
            <td align="right">ຫ້ອງການ:</td>
            <td><input type="text" class="form-control" name="office"></td>
          </tr>
        </table>
