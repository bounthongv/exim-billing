...
/*
 select product_sale.* ,sum(product_sale.qty) as t_qty
  ...
  <tr>
    ...
    <td align="right"><strong><?php  if($f["t_qty"]*$f["price"]=='0'){ echo "Free"; }else{ echo @number_format($f["t_qty"]*$f["price"],0); } ?></strong></td>
  </tr>
  <?php 
 ...
 @$amount += $f["t_qty"]*$f["price"];
  ...
  <tr>
  <td colspan="4" align="right"><strong>Total/ລວມ: </strong><strong id='money_charter'></strong></td>
