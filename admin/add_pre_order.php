...
function load_supplier()
 ...
 function load_order_receipt()
	{
			$.ajax({
			//url:"fetch_cart_pre_order.php", // old
...
<div class="container">
    <br>
    <h3 align="center">ໃບສັ່ງຊື້</h3><br>
  </div> 
    ...
    <!-- /.container -->
 <div class="container">   
    	<form action="insert_add_pre_order.php" method="post" enctype="multipart/form-data" name="me">

	<div class="form-group row">
    <div class="col-sm-10">
    <a href="index.php"><button type="button" name="close"  class="btn btn-danger"><i class="fa fa-times"></i>&nbsp;ປິດ</button></a>
      <a href="cart_pre_order.php?action=empty"><button type="button" class="btn btn-success"><i class="fa fa-plus-square"></i>&nbsp;ເພີ່ມໃໜ່</button></a>
      <button type="submit" name="save" class="btn btn-primary" value="save"><i class="fa fa-file"></i>&nbsp;ບັນທືກ</button>
     <a href="cart_pre_order.php?action=empty">
...
<table border="0">
 ...
 <tr>
  ...
  <tr>
    ...
    <input type="text" class="form-control" name="supplier_name" id="supplier_name" value="<?php if(isset($_GET['s_id'])){ echo $_GET['s_id'].'&nbsp;'.$_GET['s_name']; } ?>" >
    <span class="input-group-addon">
    <input type="hidden" class="form-control" name="supplier_id"   id="supplier_id" value="<?php if(isset($_GET['s_id'])){ echo $_GET['s_id']; } ?>"  >
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <tr>         
         ...
         <td><a href="add_pre_order.php?s_id=<?=$f['supplier_id'];?>&s_name=<?=$f['supplier_name'];?>"><button type="button" name="cc" class="btn btn-sm btn-success" >ເລືອກ</button></a></td>
        </tr>
        <?php } ?>
