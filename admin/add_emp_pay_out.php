...
$sql_max=mysqli_query($con,"SELECT max(`no`) from tbl_empty_pay_out_note where office_id='$office1'");
...
<script>
  ...
  if (r == true) {
     window.location = 'delete_empty_return_note.php?Id='+Id+'';
  } 
...
window.open('print_empty_return_note.php','_blank');
...
<td><button type="submit" name="save" value="save" class="btn btn-success"><i class="fa fa-plus-square"></i>&nbsp; ບັນທຶກ</button></td>

<table border="0">

<tr>
<td align="center">ເລກທີສົ່ງ: <br><input type="text" class="form-control ss" name="no" id="no" value="<?php echo @$lge_id;  ?>" readonly></td>
<td align="center">ວັນທີສົ່ງ: <br><input type="date" class="form-control ss" name="Sending_date" id="Sending_date" value="<?php echo @date('Y-m-d');  ?>" ></td>
<td align="center">ເລກລົດ: <br>



<input type="text" class="form-control" name="Truck_Number" id="Truck_Number" value=""  >
...
<td align="center">ຊື້ຄົນຂິບລົດ: <br><input type="text" class="form-control" name="Driver_Name" id="Driver_Name" value=""  ></td>
</tr>

<tr>
<td align="center" colspan="2">ຊື່ຕົວແທນສົ່ງ: <br><input type="text" class="form-control" name="Distributor_Name" id="Distributor_Name" value="" ></td>
</tr>
