...
if(isset($_POST["action"]))
{
	if($_POST["action"] == "add")
	{
		...
		if(isset($_SESSION["cart_edit_transfer_mini_stock"]))
		{
			...
			{   
				...
				if($_SESSION["cart_edit_transfer_mini_stock"][$keys]['Product_ID'] == $_POST["Product_ID"])
				{
										
					$is_available++;
					if($_SESSION["cart_edit_transfer_mini_stock"][$keys]['product_quantity'] == $_POST["qty_limit"])
					{  }
					else{
					
					$_SESSION["cart_edit_transfer_mini_stock"][$keys]['product_quantity'] = $_SESSION["cart_edit_transfer_mini_stock"][$keys]['product_quantity'] +                      $_POST["product_quantity"];								 
					}
				}
	...
	if($_POST["action"] == 'update')
	{
		foreach($_SESSION["cart_edit_transfer_mini_stock"] as $keys => $values)
		{
			...
			if($_POST["product_quantity"]>$_SESSION["cart_edit_transfer_mini_stock"][$keys]['product_quantity'])
			{
				$_SESSION["cart_edit_transfer_mini_stock"][$keys]['product_quantity']=$_SESSION["cart_edit_transfer_mini_stock"][$keys]['qty_limit'];
