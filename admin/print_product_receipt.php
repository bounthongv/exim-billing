...
if($receipt_id==''){$r_id="";}  else{ $r_id="where  product_receipt.receipt_id='$receipt_id' ";}
	 ...
	 $sql = mysqli_query($con," SELECT product_receipt.*,stocks.stock_name,products.Product_ID,products.Product_Name,products.size,products.Unit ,tb_groups.Group_Name
