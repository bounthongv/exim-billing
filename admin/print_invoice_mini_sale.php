...
<head>
  ...
  <div id="invoice-POS">
    <div id="mid">
      ...
      <h2> &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;<font style="font-family:Saysettha OT, Phetsarath OT;">ໃບຮັບເງີນ</font> / Receipt </h2>
        <p> EXIM <br>
 ...
 <?php 
		 ...
		 where product_sale.sale_id='$sale_id'  group by product_sale.product_id ");
                  ...
                  <tr> 
                  <td colspan="3">
                  <p><strong><font style="font-family:Saysettha OT, Phetsarath OT;">ຍອດຊຳລະ</font>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <?php echo @number_format($total_last_amount,0); ?></strong></p>
                  <p><strong><font style="font-family:Saysettha OT, Phetsarath OT;">ຍອດຊຳລະ</font>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <?php echo @number_format($total_last_amount,0); ?></strong></p>
                  </td>
                  </tr>
							<!--<tr class="tabletitle">
...
-->
                       <!--
							<tr class="tabletitle">
								...
								<td class="Rate">
                                <h2>Total                          <br>
                                <font style="font-family:Saysettha OT, Phetsarath OT;">ຍອດຊຳລະ</font>
                                <br>
                               <font style="font-family:Saysettha OT, Phetsarath OT;">ຍອດຄ່າງຊຳລະ</font>
                                <br>
                                <font style="font-family:Saysettha OT, Phetsarath OT;">ຮັບຕົວຈີງ</font>
                                </h2>
                                </td>
                                <td></td>
								<td class="payment">
                                <h2>
                                <?php echo @number_format($total_last_amount,0); ?><br>   
								<?php echo @number_format($total_last_amount,0); ?><br>                                 
                                <?php echo @number_format($total_last_amount,0); ?><br>
                                <?php echo @number_format($total_last_amount,0); ?><br>
                                </h2>
...
<div id="mid">
   ...
   <br> 
    <br> 
    <p > ---------------------------------------------------------------<br>
  &nbsp;&nbsp;&nbsp;&nbsp;<font style="font-family:Saysettha OT, Phetsarath OT;">ລາຍເຊັນຜູ້ຈ່າຍ </font> </p>
   ...
   <p >  
    ---------------------------------------------------------------<br>
   &nbsp;&nbsp;&nbsp;&nbsp; <font style="font-family:Saysettha OT, Phetsarath OT;">ລາຍເຊັນຜູ້ຮັບ  &nbsp;&nbsp;&nbsp;&nbsp; <?php echo $stock_name; ?></font></p>
					</div>
