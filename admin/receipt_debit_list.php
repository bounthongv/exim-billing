...
$(document).ready(function(){
 ...
 function load_list()
	{
			$.ajax({
			url:"fetch_receipt_debit_list.php",
			method:"POST",
			//dataType:"json",
...
function load_product()
	{
			$.ajax({
			url:"fetch_product_receipt_supplier_detail.php",
			method:"POST",
			//dataType:"json",
			success:function(data)
			{
...
$(function(){
 ...
 //  alert(stock_id);
         ...
         $.ajax({
				url:"fetch_receipt_debit_list.php",
				method:"POST",
				data:{  stock_id:stock_id,from_date:from_date,to_date:to_date,receipt_id:receipt_id,supplier_id:supplier_id },
				success:function(data)
				{
					$('#head_list').html(data);
...
$(document).on('click', '.payment', function(){
	...
	//	var action = $(this).attr("value");
     ...
     window.location = 'payment_supplier.php?receipt_id='+receipt_id ;
...
$(document).on('click', '#print', function(){
  ...
  // var group_id = $('#group_id').val(); 
	//	var action = $(this).attr("value");
     ...
     window.open('print_sale_debit_list.php?stock_id='+stock_id+'&from_date='+from_date+'&to_date='+to_date+'&sale_id='+sale_id+'','_blank'); 
...
<div class="container">
    <br>
    <h3 align="center">ລາຍງານໜີ້ຜູ້ສະໜອງ</h3><br>
...
<table>
	...
	<?PHP } ?>
         ...
         <td>ລະຫັດຜູ້ສະໜອງ<br><input  type="text" name="supplier_id" id="supplier_id" class="form-control"  ></td> 
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-header">
          <h4 class="modal-title">ລາຍງານໜີ້ຜູ້ສະໜອງ</h4>
