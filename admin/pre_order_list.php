...
function load_product_detail()
	{
			$.ajax({
			url:"fetch_pre_order_detail.php",
			method:"POST",
			//dataType:"json",
			success:function(data)
			{
...
$(document).on('click', '.edit_Id', function(){
	...
	//	var action = $(this).attr("value");
     ...
     window.location = 'cart_edit_pre_order.php?id='+id ;
...
$(document).on('click', '.delete_Id', function(){
  ...
  if (r == true) {
     window.location = 'delete_pre_order.php?id='+id ;
  } 
	...
	$(document).on('click', '.print_Id', function(){
		...
		var receipt_id = $(this).attr("id");
	//	var action = $(this).attr("value");
window.open('print_pre_order_2.php?receipt_id='+receipt_id+' ','_blank');
	});	  	  
...
<div class="container">
    <br>
    <h3 align="center">ລາຍການສັ່ງຊື້</h3><br>
       ...
       <td> <br><a href="add_pre_order.php"  ><button type="button" class="btn btn-success" >
            <i class="fa fa-plus-square"></i>&nbsp; ສັງຊື້</button></a></td>
 ...
 <div class="modal" id="pro_detail">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <!-- Modal Header -->
        <div class="modal-header">
          <h4 class="modal-title">ລາຍການສັ່ງຊື້</h4>
          <button type="button" class="close" data-dismiss="modal">&times;</button>
        </div>
