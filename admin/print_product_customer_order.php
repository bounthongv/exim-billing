...
<table width="100%" border="1">
  <tr align="center">
   ...
   <?php 
if($sale_id==''){$r_id="";}  else{ $r_id="where  product_customer_order.sale_id='$sale_id' ";}
			
	 $sql = mysqli_query($con," SELECT product_customer_order.*,stocks.stock_name,products.Product_ID,products.Product_Name,products.size,products.Unit ,tb_groups.Group_Name
		   FROM  product_customer_order 
		left join products on products.Product_ID=product_customer_order.product_id
  ...
  <tr>
    ...
    <td align="center"><?php echo $f["sale_id"]; ?></td>
    
    
    <td align="center"><?php echo $f["sale_date"]; ?></td>
    ...
    <td align="right"><?php echo $f["Unit"];?></td>
     ...
     <td align="right"><?php echo @number_format($f["qty"]* $f["price"],0);  ?></td>
